...
export function ImageCardComponent(props) {
      ...
      <CardItem cardBody style={{padding: 5}}>
        <Grid>
          <Col size={90}>
            ...
            {uploadingStarted && <UIActivityIndicator style={{position: 'absolute', top: '39%', left: '43%'}} color='orange'></UIActivityIndicator>}
              ...
              <Button transparent>
                {!uploading &&
                  ...
                  >
                    ...
                    {/* <Image source={require('../images/nfc-icon.jpg')} style={{marginTop: 7, marginBottom: 'auto', marginLeft: -2}} /> */}
                  </TouchableOpacity>
                }
                {uploading &&
                  <TouchableOpacity
